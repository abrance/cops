...
| `model-ocr` | `model-ocr` | `ghcr.chenby.cn/abrance/modelman-ocr` | PP-OCR 文字识别服务（MNN/CPU）；只监听 `127.0.0.1:9101`，与 `lems` 通过 `cops-shared` 网络互访；源码仓库 [abrance/modelman](https://github.com/abrance/modelman) |
